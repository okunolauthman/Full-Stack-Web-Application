...
/*validate all variable that will be used to access all the html dom*/
function ready() {
  ...
  //Buy Button
  document.getElementsByClassName('btn-buy')[0].addEventListener('click', buybuttonClicked);// The index [0] is used to target the first element in the collection.

  updateCart(); //function defined else where
}//end
